...
Relációk: User–Ticket 1:N, Ticket–Reply 1:N, User–Reply 1:N.
...
Sikeres válasz 201: {"message":"User created successfully", "user":{...}}
...
Sikeres válasz 200: {"message":"Login successful", "user":{...}, "access":{"token":"..."}}
...
Futtatás: php artisan migrate:fresh --seed
